...
// Cloudinary URLs - Ersetze diese mit deinen echten Cloudinary Video URLs
const promoVideos = [
  'https://res.cloudinary.com/DEIN_CLOUD_NAME/video/upload/v1234567890/promo/video1.mp4',
  'https://res.cloudinary.com/DEIN_CLOUD_NAME/video/upload/v1234567890/promo/video2.mp4',
  'https://res.cloudinary.com/DEIN_CLOUD_NAME/video/upload/v1234567890/promo/video3.mp4',
  // Füge weitere Cloudinary URLs hinzu
]

export default function PromoAdCloudinary({ className = '' }: PromoAdProps) {
