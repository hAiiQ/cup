                  ...
                  >
                    ...
                    {filteredUsers.slice(0, 12).map((user, index) => {
                      ...
                      return (
                        <div
                          key={user.id}
                          className="absolute w-full h-full flex items-center justify-center text-white text-sm md:text-base font-semibold"
                          style={{
                        ...
                        >
                          <div
                            className="absolute"
                            style={{
                              transform: 'translateY(-170px) md:translateY(-210px) rotate(90deg)',
                              transformOrigin: 'center'
                            }}
                          >
                            {user.username}
